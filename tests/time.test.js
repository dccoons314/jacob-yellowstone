...
test('formatRelativeLabel returns "0h 0m ago" for sub-minute past times', () => {
  const now = new Date('2026-06-05T03:00:30Z');
  const target = new Date('2026-06-05T03:00:00Z');
  assert.equal(formatRelativeLabel(target, now), '0h 0m ago');
});
